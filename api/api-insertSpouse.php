...
$sql = "INSERT INTO `smart_will`.`spouse` (`id`, `first_name`, `mid_name`, `sur_name`, `address`, `post_code`, `telephone`, `email`, `date_of_birth`, `gender`, `u_id`, `created_at`, `updated_at`) 
...
if ($conn->query($sql) === TRUE) {
    $response = array("Status"=>"Ok", "Error"=>"", "Data"=> $sql);
} else {
